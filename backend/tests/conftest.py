...
from app.services import alert_webhook_client as alert_webhook_client_module  # noqa: E402


@pytest.fixture(autouse=True)
def patch_health_check_dns_resolver(monkeypatch: pytest.MonkeyPatch) -> None:
    """Keep outbound Health Check and alert-webhook tests deterministic and off the real network."""
    monkeypatch.setattr(
