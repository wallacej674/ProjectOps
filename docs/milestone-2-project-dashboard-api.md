...
Milestone 5 replaces the placeholder `latest_health_check` section with the latest attempted Health Check snapshot when Manual Health Monitor has run. Readiness scoring remains a placeholder.
